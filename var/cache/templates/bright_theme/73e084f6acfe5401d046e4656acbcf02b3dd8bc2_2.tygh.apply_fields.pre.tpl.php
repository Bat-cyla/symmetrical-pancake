<?php
/* Smarty version 4.1.1, created on 2024-08-20 13:26:21
  from '/app/www/design/themes/responsive/templates/addons/cp_otp_registration/hooks/vendors/apply_fields.pre.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_66c46f4dd7c390_05170324',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '73e084f6acfe5401d046e4656acbcf02b3dd8bc2' => 
    array (
      0 => '/app/www/design/themes/responsive/templates/addons/cp_otp_registration/hooks/vendors/apply_fields.pre.tpl',
      1 => 1724149494,
      2 => 'tygh',
    ),
  ),
...
function content_66c46f4dd7c390_05170324 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/app/www/app/functions/smarty_plugins/function.set_id.php','function'=>'smarty_function_set_id',),));
\Tygh\Languages\Helper::preloadLangVars(array('phone','cp_otp_phone_verification','cp_otp_phone_confirm','cp_otp_send_again_after','cp_otp_phone_need_confirm','cp_otp_phone_verification','cp_phone_confirmed','phone','cp_otp_phone_verification','cp_otp_phone_confirm','cp_otp_send_again_after','cp_otp_phone_need_confirm','cp_otp_phone_verification','cp_phone_confirmed'));
...
" name="company_data[phone]" autocomplete="n" <?php if ($_smarty_tpl->tpl_vars['placeholder']->value) {?>placeholder="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['placeholder']->value, ENT_QUOTES, 'UTF-8');?>
"<?php }?>>
        
        <?php if (fn_needs_image_verification("cp_otp") == true) {?>
            <?php $_smarty_tpl->_assignInScope('cp_btn_href', fn_url("cp_otp.pre_verification?otp_type=register&obj_id=".((string)$_smarty_tpl->tpl_vars['obj_id']->value)."&phone=".((string)$_smarty_tpl->tpl_vars['phone']->value)."&redir_dispatch=companies"));?>
        <?php } else { ?>
            <?php $_smarty_tpl->_assignInScope('cp_btn_href', fn_url("companies.cp_phone_verification?otp_type=register&obj_id=".((string)$_smarty_tpl->tpl_vars['obj_id']->value)."&phone=".((string)$_smarty_tpl->tpl_vars['phone']->value)));?>
        <?php }?>
        ...
        <div class="cp-verification-wrap">
            ...
            <?php }?>
            <a class="ty-btn ty-btn__primary cp-verification-link cm-dialog-auto-size cm-dialog-opener cm-ajax <?php if ($_smarty_tpl->tpl_vars['send_in_ses_dif']->value && !$_smarty_tpl->tpl_vars['phone_verified']->value) {?>cp-otp__hard-hidden<?php }?> <?php if ($_smarty_tpl->tpl_vars['code_valid']->value) {?>cp-otp__run-again-timer<?php }?>" 
...
">
            ...
            <div class="cp__otp-new-send <?php if (!$_smarty_tpl->tpl_vars['send_in_ses_dif']->value || $_smarty_tpl->tpl_vars['phone_verified']->value) {?>hidden<?php } else { ?>cp-otp__run-separately<?php }?>" id="cp_otp_new_send_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
" object_id="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
if ($_smarty_tpl->tpl_vars['auth']->value['area'] == "A") {?><span class="cm-template-box template-box" data-ca-te-template="addons/cp_otp_registration/hooks/vendors/apply_fields.pre.tpl" id="<?php echo smarty_function_set_id(array('name'=>"addons/cp_otp_registration/hooks/vendors/apply_fields.pre.tpl"),$_smarty_tpl);?>
