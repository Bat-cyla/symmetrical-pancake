...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_66ab3ab9309f64_26601270',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c577e7bb7e94d6c330d508c7ac91d2ade6072115' => 
    array (
      0 => '/app/www/design/backend/templates/views/storefronts/components/picker/picker.tpl',
      1 => 1693486476,
      2 => 'tygh',
    ),
  ),
...
function content_66ab3ab9309f64_26601270 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_subTemplateRender("tygh:pickers/storefronts/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('picker_id'=>"object_picker_advanced_".((string)$_smarty_tpl->tpl_vars['picker_id']->value),'data_id'=>"om",'no_container'=>true,'icon'=>"icon-reorder",'but_text'=>$_prefixVariable14,'show_but_text'=>false,'view_mode'=>"button",'meta'=>"object-picker__advanced-btn object-picker__advanced-btn--storefronts ".((string)$_smarty_tpl->tpl_vars['object_picker_advanced_btn_class']->value)), 0, false);
?>
            </div>
        <?php }?>
...
echo htmlspecialchars((string) smarty_modifier_to_json(array(array("id"=>0,"text"=>$_prefixVariable15,"data"=>array("name"=>$_prefixVariable16)))), ENT_QUOTES, 'UTF-8');?>
"
                    <?php }?>
...
$_smarty_tpl->_subTemplateRender("tygh:views/storefronts/components/picker/item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('type'=>"selection",'title_pre'=>$_prefixVariable17,'title_post'=>$_prefixVariable18), 0, false);
?>
    </div>
<?php echo '</script'; ?>
>
