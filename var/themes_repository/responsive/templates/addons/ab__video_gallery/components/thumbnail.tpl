...
{$image_additional_attrs = [
    ...
    "data-ab-vg-video-path" => $video.video_path
]}
...
{if $video.icon_type == "icon"}
    ...
    {else}
        <img src="" alt="ab_vg_placeholder" width="0" height="0" style="display: none;" {$image_additional_attrs|render_tag_attrs nofilter}>
    {/if}
{else}
    {$image = [
