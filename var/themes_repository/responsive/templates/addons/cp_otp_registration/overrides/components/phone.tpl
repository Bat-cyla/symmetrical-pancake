    ...
    *}
    ...
    {if $addons.cp_otp_registration.use_country_prefix == "Y"}
        {if $addons.cp_otp_registration.default_country}
            {$country_code=$addons.cp_otp_registration.default_country}
    ...
    {/if}
    {if $addons.cp_otp_registration.use_country_prefix == "Y" && empty($value)}
        {if $addons.cp_otp_registration.default_country }
            {$value =$countries[$country_code|lower].symbol}
        {else}
            {$value =$countries[$country_code|lower].symbol}
        {/if}
    {/if}
    ...
    <div class="cm-field-container {if $is_phone_number_with_country_selection}ty-input-append ty-input-append--phone-mask{/if} {$input_phone_container_class}">
        ...
        {/if}
        {$extra nofilter}
        {if $is_phone_number_with_country_selection || $addons.cp_otp_registration.use_country_prefix == "Y"}
            {if $addons.cp_otp_registration.default_country}{$country_code=$addons.cp_otp_registration.default_country}{/if}
            {include file="common/select_object.tpl"
                ...
                class="cm-phone-number-with-country-selection-btn-group ty-btn-group--phone-mask ty-dropright `$btn_group`"
