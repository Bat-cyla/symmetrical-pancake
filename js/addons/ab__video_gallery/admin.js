...
_.ab__vg.change_required_fields = function(input, video_id, value) {
var inputs_wrapper = $(input).parents('.cm-row-item');
if (!inputs_wrapper.length) {
inputs_wrapper = $('#box_add_ab__vg_video');
}
var icon_types_inputs = inputs_wrapper.find('.ab__vg__icon_type input');
