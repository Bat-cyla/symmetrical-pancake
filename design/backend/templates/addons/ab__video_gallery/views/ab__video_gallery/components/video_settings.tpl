...
{$disabled = true}
{/if}
<select {if $disabled}disabled="disabled"{/if} title="{__("ab__vg.form.type")}" name="product_data[ab__vg_videos][{$key}][type]" onchange="Tygh.ab__vg.change_required_fields(this, {$key}, this.value)">
