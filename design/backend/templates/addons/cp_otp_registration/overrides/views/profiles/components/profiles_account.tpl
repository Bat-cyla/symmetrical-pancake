...
<div class="control-group">
    <label for="phone" class="control-label cm-required">{__("phone")}:</label>
    <div class="controls">
        <input type="text" id="phone" name="user_data[phone]" class="input-large" size="32" maxlength="25" value="{$user_data.phone}" autocomplete="n"/>
